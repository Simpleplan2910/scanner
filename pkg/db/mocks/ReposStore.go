...
func (_m *ReposStore) Add(ctx context.Context, v *db.Repos) (primitive.ObjectID, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *db.Repos) (primitive.ObjectID, error)); ok {
		return rf(ctx, v)
	}
...
func (_m *ReposStore) Archive(ctx context.Context, id primitive.ObjectID) error {
...
func (_m *ReposStore) Filter(ctx context.Context, filter *db.FilterRepos) ([]db.Repos, int64, error) {
	...
	var r1 int64
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, *db.FilterRepos) ([]db.Repos, int64, error)); ok {
...
func (_m *ReposStore) Get(ctx context.Context, id primitive.ObjectID) (*db.Repos, error) {
	...
	var r0 *db.Repos
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, primitive.ObjectID) (*db.Repos, error)); ok {
		return rf(ctx, id)
	}
...
type mockConstructorTestingTNewReposStore interface {
	mock.TestingT
	Cleanup(func())
}

// NewReposStore creates a new instance of ReposStore. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewReposStore(t mockConstructorTestingTNewReposStore) *ReposStore {
	mock := &ReposStore{}
	mock.Mock.Test(t)
